        ...
        <div className={`mt-[15px] w-full ${!props.isDemo && 'ml-[-30px] sticky top-24 left-0 z-30'}`}>
            {
                videoSections.map((section: string, sectionIndex: number) => {
                    ...
                    const sectionVideoCount: number = sectionVideos.length; // Number of videos is the current section
                    ...
                    return (
                        <div className={`${!props.isDemo && 'border-b border-[#ffffffBe] pb-2'}`} key={section}>
