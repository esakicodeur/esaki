...
const DashboardHeader: FC<Props> = ({ open, setOpen }) => {
    ...
    const [audio] = useState(
        new Audio(
            "https://res.cloudinary.com/dt2bm2kmn/video/upload/v1707642591/couhnfz0jedzqpshapcb.wav"
        )
    );
                ...
                open && (
                    <div className='w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-10 rounded'>
                        ...
                        {notifications && notifications.map((item: any, index: number) => (
                            <div key={index} className='dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff42] border-b-[#0000000f]'>
